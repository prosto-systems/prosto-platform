...
- When answering questions about available commands, source of truth is root `package.json`; lint and architecture-policy scripts plus `test:contracts` are available, while runtime-policy and lifecycle-determinism checks remain placeholders.
