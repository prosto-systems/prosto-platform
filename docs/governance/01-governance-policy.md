...
- `FF-01 kernel boundary guard`
- `FF-02 dependency policy guard`
- `FF-04 runtime-policy`
- `FF-03 lifecycle determinism (placeholder)`
- `FF-05 contracts gate`
...
- Runtime policy evidence FF-04
- Quality evidence FF-03 and FF-05
