...
export class auth_session_create_tables1710000000000 implements MigrationInterface {
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        name: 'auth_session_sessions',
        columns: [
          {
            name: 'sessionIdHash',
            type: 'varchar',
    ...
    await queryRunner.createIndex(
      'auth_session_sessions',
      new TableIndex({
        name: 'idx_auth_session_sessions_expiry',
    ...
    await queryRunner.createTable(
      new Table({
        name: 'auth_session_transactions',
        columns: [
          {
    ...
    await queryRunner.createIndex(
      'auth_session_transactions',
      new TableIndex({
        name: 'idx_auth_session_transactions_expiry',
    ...
    await queryRunner.createIndex(
      'auth_session_transactions',
      new TableIndex({
        name: 'idx_auth_session_transactions_state',
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('auth_session_transactions');
    await queryRunner.dropTable('auth_session_sessions');
  }
}
