...
import { type IPlatformConfig, RuntimeReasonCodes } from '@/runtime/index.js';
...
export class ConfigAccessPolicyStrategy implements IConfigAccessPolicyStrategy {
  ...
  evaluate(
    ...
    if (wildcardCapabilities.length) {
      return {
        granted: false,
        denialCode: RuntimeReasonCodes.ConfigWildcardForbidden,
    ...
    if (unknownCapabilities.length && policy.denyOnUnknownCapability) {
      return {
        granted: false,
        denialCode: RuntimeReasonCodes.ConfigCapabilityInvalid,
    ...
    if (deniedSections.length) {
      return {
        granted: false,
        denialCode: RuntimeReasonCodes.ConfigSectionNotAllowlisted,
    ...
    if (
      ...
      return {
        granted: false,
        denialCode: RuntimeReasonCodes.ConfigAccessDenied,
